...
namespace GSM05500Model.Model
{
    public class GSM05510Model : R_BusinessObjectServiceClientBase<GSM05510DTO>, IGSM05510
    {
        ...
        public async Task<List<GSM05510DTO>> GetAllStreamAsync()
        {

            var loEx = new R_Exception();
            List<GSM05510DTO> loResult = null;

            try
            {
                R_HTTPClientWrapper.httpClientName = _HttpClientName;
                loResult = await R_HTTPClientWrapper.R_APIRequestStreamingObject<GSM05510DTO>(
                    _RequestServiceEndPoint,
                    nameof(IGSM05510.GetAllRateTypeStream), DEFAULT_MODULE,
                    _SendWithContext,
                    _SendWithToken,
                    null);
            }
