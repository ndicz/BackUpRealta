...
{
    public partial class GSM00720 : R_Page
    {
        ...
        private R_ConductorGrid _conGSM00720YearRef;
        ...
        protected override async Task R_Init_From_Master(object poParameter)
        {
            ...
            try
            {
                var param = (GSM00710DTO)poParameter;
                GSM00720ViewModel.CashFlowGroupCode = param.CCASH_FLOW_GROUP_CODE;
                GSM00720ViewModel.CashFlowGroupName = param.CCASH_FLOW_GROUP_NAME;
                GSM00720ViewModel.CashFlowPlanCode = param.CCASH_FLOW_CODE;
                GSM00720ViewModel.CashFlowPlanName = param.CCASH_FLOW_NAME;
        ...
        protected async override Task<bool> R_LockUnlock(R_LockUnlockEventArgs eventArgs)
        {
            ...
            try
            {
                var loData = (GSM00720DTO)eventArgs.Data;
                ...
                if (eventArgs.Mode == R_eLockUnlock.Lock)
                {
                    var loLockPar = new R_ServiceLockingLockParameterDTO
                    {
                        ...
                        Key_Value = string.Join("|", clientHelper.CompanyId, loData.CCASH_FLOW_GROUP_CODE,
                            loData.CCASH_FLOW_CODE, loData.CYEAR, loData.CPERIOD_NO)
                    };
