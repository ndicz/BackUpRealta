...
namespace ReportService
{
    ...
    [ApiController]
    public class ProductObjectController : ControllerBase, IProductObject
    {
        private R_ReportFastReportBackClass _ReportCls;
        private AllProductParameterDTO _AllProductParameter;

        #region instantiate
        public ProductObjectController()
        {
        ...
        {
            pcFileTemplate = "Reports\\ProductObject.frx"; //ini nama file report
        }
